...
export default function TasksPage() {
  const [tasks, setTasks] = useState<Task[]>([
    { id: 1, task_name: 'Warehouse Restocking', description: 'Help restock shelves in warehouse zone B.', task_date: '2026-06-25', start_time: '08:00', end_time: '12:00', priority: 'Medium', status: 'Approved', department_name_label: 'Warehouse' },
    { id: 2, task_name: 'Loading Dock Help', description: 'Assist loading delivery trucks.', task_date: '2026-06-26', start_time: '07:00', end_time: '10:00', priority: 'High', status: 'Approved', department_name_label: 'Logistics' },
    { id: 3, task_name: 'Stock Count Assist', description: 'Help with the monthly stock count.', task_date: '2026-06-24', start_time: '09:00', end_time: '13:00', priority: 'Low', status: 'Completed', department_name_label: 'Warehouse' },
    { id: 4, task_name: 'Customer Returns Sorting', description: 'Sort and label returned goods.', task_date: '2026-06-22', start_time: '13:00', end_time: '15:00', priority: 'Low', status: 'Cancelled', department_name_label: 'Operations' },
  ]);
