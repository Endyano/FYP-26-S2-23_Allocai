...
export default function HistoryPage() {
  const [tasks, setTasks] = useState<Task[]>([
    { id: 3, task_name: 'Stock Count Assist', task_date: '2026-06-24', start_time: '09:00', end_time: '13:00', status: 'Completed', department_name_label: 'Warehouse' },
    { id: 5, task_name: 'Packing Line Support', task_date: '2026-06-18', start_time: '08:00', end_time: '12:00', status: 'Completed', department_name_label: 'Operations' },
    { id: 6, task_name: 'Delivery Assist', task_date: '2026-06-12', start_time: '09:00', end_time: '15:00', status: 'Completed', department_name_label: 'Logistics' },
  ]);
