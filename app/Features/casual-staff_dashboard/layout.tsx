      ...
      <div className="flex min-h-screen bg-slate-50 text-slate-900 font-sans selection:bg-indigo-100">
        ...
        <aside className="flex w-72 flex-col justify-between bg-white border-r border-slate-200 shadow-[4px_0_24px_rgba(0,0,0,0.02)] z-10">
          <div className="py-8">
            ...
            <nav className="flex flex-col px-4 space-y-2">
              <Link href="/Features/casual-staff_dashboard" className={`flex items-center gap-4 px-4 py-3 rounded-xl text-sm font-semibold transition-all duration-200 ${pathname === '/Features/casual-staff_dashboard' ? 'bg-slate-100 text-slate-900 shadow-sm' : 'text-slate-500 hover:bg-slate-50 hover:text-slate-900'}`}>
              ...
              <Link href="/Features/casual-staff_dashboard/tasks" className={`flex items-center gap-4 px-4 py-3 rounded-xl text-sm font-semibold transition-all duration-200 ${pathname.includes('/tasks') ? 'bg-slate-100 text-slate-900 shadow-sm' : 'text-slate-500 hover:bg-slate-50 hover:text-slate-900'}`}>
              ...
              <Link href="/Features/casual-staff_dashboard/schedule" className={`flex items-center gap-4 px-4 py-3 rounded-xl text-sm font-semibold transition-all duration-200 ${pathname.includes('/schedule') ? 'bg-slate-100 text-slate-900 shadow-sm' : 'text-slate-500 hover:bg-slate-50 hover:text-slate-900'}`}>
              ...
              <Link href="/Features/casual-staff_dashboard/history" className={`flex items-center gap-4 px-4 py-3 rounded-xl text-sm font-semibold transition-all duration-200 ${pathname.includes('/history') ? 'bg-slate-100 text-slate-900 shadow-sm' : 'text-slate-500 hover:bg-slate-50 hover:text-slate-900'}`}>
              ...
              <Link href="/Features/casual-staff_dashboard/profile" className={`flex items-center gap-4 px-4 py-3 rounded-xl text-sm font-semibold transition-all duration-200 ${pathname.includes('/profile') ? 'bg-slate-100 text-slate-900 shadow-sm' : 'text-slate-500 hover:bg-slate-50 hover:text-slate-900'}`}>
        ...
        <main className="flex-1 p-10 overflow-y-auto">
          <div className="max-w-5xl mx-auto space-y-8">
            ...
            {/* INI BAGIAN HEADER DENGAN BADGE CASUAL EMPLOYEE */}
            <header className="flex items-end justify-between border-b border-slate-200 pb-6">
              <div>
                <div className="flex items-center gap-3">
                  ...
                  <span className="hidden sm:inline-flex items-center gap-1.5 px-3 py-1 bg-indigo-50 text-indigo-600 text-[10px] font-extrabold uppercase tracking-widest rounded-lg border border-indigo-200/50 shadow-sm mt-1.5">
                ...
                {/* Badge Role untuk layar HP (Mobile) */}
                <span className="sm:hidden inline-flex items-center gap-1.5 px-3 py-1 bg-indigo-50 text-indigo-600 text-[10px] font-extrabold uppercase tracking-widest rounded-lg border border-indigo-200/50 shadow-sm mt-3">
                  Casual Employee
                </span>
              </div>
            </header>
