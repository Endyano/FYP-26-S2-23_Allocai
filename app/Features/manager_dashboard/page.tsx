...
export default function DashboardPage() {
  const [totalStaff] = useState<number>(12);
  const [pendingTasks] = useState<number>(5);
  const [totalDepartments] = useState<number>(4);

  const [tasks, setTasks] = useState<any[]>([
    { id: 1, task_name: 'Morning Stock Check', department_label: 'Warehouse', staff_name: 'Rajan Kumar', task_date: '2026-06-25', priority: 'High', status: 'Pending' },
    { id: 2, task_name: 'Delivery Route A', department_label: 'Logistics', staff_name: 'Wei Jie Lim', task_date: '2026-06-25', priority: 'Medium', status: 'Approved' },
    { id: 3, task_name: 'Cold Storage Inspection', department_label: 'Quality Control', staff_name: 'Priya Nair', task_date: '2026-06-24', priority: 'High', status: 'Completed' },
    { id: 4, task_name: 'Inventory Reconciliation', department_label: 'Warehouse', staff_name: null, task_date: '2026-06-26', priority: 'Low', status: 'Pending' },
    { id: 5, task_name: 'Customer Returns Processing', department_label: 'Operations', staff_name: 'Hafiz Zulkifli', task_date: '2026-06-23', priority: 'Medium', status: 'Cancelled' },
  ]);
  const [tasksLoading] = useState(false);
  const [taskFilter, setTaskFilter] = useState('All');

  const [disputes, setDisputes] = useState<any[]>([
    { id: 1, staff_name: 'Rajan Kumar', task_name: 'Morning Stock Check', task_date: '2026-06-20', start_time: '08:00', end_time: '12:00', claimed_hours: 5, reason: 'I worked overtime to finish the full inventory count.', status: 'Pending', manager_note: null, created_at: '2026-06-21' },
  ]);
  const [disputesLoading] = useState(false);
